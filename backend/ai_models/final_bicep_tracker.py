...
def process_bicep(frame):
    ...
    """
    global counters, states, feedback, elbow_start_pos
    ...
    arms = {
        "left": {
            "shoulder": (int(keypoints[5,1]*w), int(keypoints[5,0]*h)),
            "elbow":    (int(keypoints[7,1]*w), int(keypoints[7,0]*h)),
            "wrist":    (int(keypoints[9,1]*w), int(keypoints[9,0]*h)),
            "ids": [5,7,9]
        },
        "right": {
            "shoulder": (int(keypoints[6,1]*w), int(keypoints[6,0]*h)),
