...
const styles = `
  ...
  .posture-button-secondary:hover {
    background-color: #d1d5db;
  }
`;
...
export default function PostureCheckPage() {
  ...
  const postureItems = [
    {
      id: 'back',
      title: 'Back Straight',
      instruction: 'Keep your back straight and core engaged — no slouching or leaning back.',
      image: backStraightImg,
    },
    {
      id: 'shoulders',
      title: 'Shoulders Down',
      instruction: 'Set your shoulders down and back — don\'t shrug while curling.',
      image: shouldersDownImg,
    },
    {
      id: 'elbows',
      title: 'Elbows Close',
      instruction: 'Hold elbows close to your torso — only your forearms should move.',
      image: elbowsCloseImg,
    },
    {
      id: 'wrists',
      title: 'Wrists Neutral',
      instruction: 'Keep wrists neutral and straight — don\'t bend them up or down.',
      image: wristsNeutralImg,
    },
    {
      id: 'motion',
      title: 'Controlled Motion',
      instruction: 'Curl the weight in a slow, controlled motion — lift and lower with control.',
  ...
  const handleCheckboxChange = (id, checked) => {
    ...
    const allItemsChecked = postureItems.every(item => newCheckedItems[item.id]);
          ...
          <div className="posture-confirmation">
            <div className="posture-confirmation-header">
              ...
              <div className="posture-confirmation-text">
                <h3>Important</h3>
                <p>
                  Review all posture checkpoints above and check them off. Proper form prevents injury and maximizes effectiveness.
                </p>
              </div>
            </div>
            ...
            >
              {allChecked ? 'Start Exercise' : `Check all posture points (${Object.values(checkedItems).filter(Boolean).length}/${postureItems.length})`}
            </button>
          </div>
        </div>
      </main>
